<%@ Page Title="" Language="C#" MasterPageFile="~/Page/FrontEnd.Master" AutoEventWireup="true" CodeBehind="Products.aspx.cs" Inherits="WebShop.Page.Products" %>

<asp:Content ID="Content1" ContentPlaceHolderID="main_body" runat="server">



    <asp:DataList ID="DataList1" runat="server" Width="536px" RepeatColumns="2" OnSelectedIndexChanged="DataList1_SelectedIndexChanged1">
        <ItemTemplate>
